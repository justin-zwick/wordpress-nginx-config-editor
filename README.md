[![Build Status](https://travis-ci.org/o10n-x/wordpress-nginx-config-editor.svg?branch=master)](https://travis-ci.org/o10n-x/wordpress-nginx-config-editor) ![Version](https://img.shields.io/github/release/o10n-x/wordpress-nginx-config-editor.svg)

<img src="https://github.com/o10n-x/wordpress-nginx-config-editor/blob/master/admin/images/nginx.png" align="right">

# WordPress Nginx config Editor

Advanced Nginx config editor for optimization purposes.

* [Documentation](https://github.com/o10n-x/wordpress-nginx-config-editor/tree/master/docs)
* [Description](https://github.com/o10n-x/wordpress-nginx-config-editor#description)
* [Version history (Changelog)](https://github.com/o10n-x/wordpress-nginx-config-editor/releases)
...
This plugin is a Nginx config editor with code highlighting for optimization purposes. The editor supports over 30 code highlighting themes and has built in features such as (regular expression) search & replace.

![Nginx config editor](https://github.com/o10n-x/wordpress-nginx-config-editor/blob/master/docs/images/nginx-config-editor.png)

Additional features can be requested on the [Github forum](https://github.com/o10n-x/wordpress-nginx-config-editor/issues).
