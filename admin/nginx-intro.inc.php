	...
	<div class="metabox-prefs">
		<div class="wrap about-wrap" style="position:relative;">
			<div style="float:right;">
				<a href="http://nginx.org/en/docs/beginners_guide.html" target="_blank" rel="noopener"><img src="<?php print $view->module->dir_url(); ?>admin/images/nginx.png" alt="Nginx config" width="180" height="37" border="0" style="float:right;"></a>
			</div>
			...
			<p class="about-text" style="min-height:inherit;">This plugin is a Nginx config editor for WordPress.</p>

			

			<p class="about-text" style="min-height:inherit;">Getting started? <a href="https://encrypted.google.com/search?q=nginx+optimization" target="_blank">Search Google</a> for guides to optimize your webserver.</p>

			<p class="about-text" style="min-height:inherit;">If you are happy with the plugin, please consider to <span class="star" style="display:inline-block;vertical-align:middle;"><a class="github-button" data-manual="1" data-size="large" href="https://github.com/o10n-x/wordpress-nginx-config-editor" data-icon="octicon-star" data-show-count="true" aria-label="Star o10n-x/wordpress-nginx-config-editor on GitHub">Star</a></span> on Github.</p>
